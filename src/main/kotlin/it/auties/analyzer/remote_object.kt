...
import org.openqa.selenium.devtools.v93.debugger.model.CallFrame
import org.openqa.selenium.devtools.v93.debugger.model.Scope
import org.openqa.selenium.devtools.v93.runtime.Runtime
import org.openqa.selenium.devtools.v93.runtime.model.PropertyDescriptor
import org.openqa.selenium.devtools.v93.runtime.model.RemoteObject
import org.openqa.selenium.devtools.v93.runtime.model.RemoteObjectId
import java.util.*
...
fun getKeyValue(property: String, id: RemoteObjectId, tools: DevTools): List<Byte>? = tools
    .send(Runtime.getProperties(id, Optional.empty(), Optional.empty(), Optional.empty()))
    .result
...
private fun getArrayPropertyId(tools: DevTools, propValueId: RemoteObjectId): RemoteObjectId? =
    tools.send(Runtime.getProperties(propValueId, Optional.empty(), Optional.empty(), Optional.empty()))
        .internalProperties
        .orThrow()
